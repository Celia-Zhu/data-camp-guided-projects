...
confirmed_cases_top7_outside_china <- read_csv(
    "datasets/confirmed_cases_top7_outside_china.csv")
# 
...
plt_cum_confirmed_cases_top7_outside_china <- ggplot(confirmed_cases_top7_outside_china, aes(date, cum_cases)) +
  geom_line(aes(date, cum_cases, group = country, color = country)) +
  ylab("Cumulative confirmed cases")

# See the plot
plt_cum_confirmed_cases_top7_outside_china
